...
var _EncryptPKCS = _interopRequireDefault(require("../model/EncryptPKCS1"));

var _EncryptPKCS1Output = _interopRequireDefault(require("../model/EncryptPKCS1Output"));
...
var V2Api = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(V2Api, [{
    ...
    key: "encryptPKCS1WithHttpInfo",
    value: function encryptPKCS1WithHttpInfo(body) {
      var postBody = body; // verify the required parameter 'body' is set
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = _EncryptPKCS1Output["default"];
      return this.apiClient.callApi('/encrypt-pkcs1', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * @param {module:model/EncryptPKCS1} body 
    ...
    key: "encryptPKCS1",
    value: function encryptPKCS1(body) {
      return this.encryptPKCS1WithHttpInfo(body).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    /**
    ...
    value: function gatewayCreateProducerNativeK8SWithHttpInfo(body) {
      ...
      return this.apiClient.callApi('/gateway-create-producer-k8s-native', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * @param {module:model/GatewayCreateProducerNativeK8S} body 
    ...
    value: function gatewayUpdateProducerNativeK8SWithHttpInfo(body) {
      ...
      return this.apiClient.callApi('/gateway-update-producer-k8s-native', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * @param {module:model/GatewayUpdateProducerNativeK8S} body 
    ...
    value: function updateNativeK8STargetWithHttpInfo(body) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = _UpdateNativeK8STarget["default"];
