 ...
 * @version 2.15.24
 */
var UIdentityConfigPart = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UIdentityConfigPart</code>.
   * @alias module:model/UIdentityConfigPart
   */
  function UIdentityConfigPart() {
    _classCallCheck(this, UIdentityConfigPart);
  ...
  _createClass(UIdentityConfigPart, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('uid_access_id')) {
          obj['uid_access_id'] = _ApiClient["default"].convertToType(data['uid_access_id'], 'String');
        }

        if (data.hasOwnProperty('uid_enable')) {
          obj['uid_enable'] = _ApiClient["default"].convertToType(data['uid_enable'], 'Boolean');
        }

        if (data.hasOwnProperty('uid_rotate_interval')) {
          obj['uid_rotate_interval'] = _ApiClient["default"].convertToType(data['uid_rotate_interval'], 'String');
        }

        if (data.hasOwnProperty('uid_status')) {
          obj['uid_status'] = _ApiClient["default"].convertToType(data['uid_status'], 'String');
        }
...
var _default = UIdentityConfigPart;
